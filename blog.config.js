...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '428b80890ff0461fa84371995d20a8a3,en:428b80890ff0461fa84371995d20a8a3',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '💔たすけて ドラえもん💔,💔ぼくもうダメかもしれない💔, 💔たすけにきて ドラえもん💔,💔セワシは ほっておいて💔,💔たすけてドラえもん💔,💔失敗ばかりの 毎日💔,💔好きな子には💔,💔無視される💔',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '遊生夢死', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '💔絶望抱くほど悪いわけじゃないけど💔', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.391314520.xyz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'kexirua@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/kexijiang', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/ke-xi', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/+W2wyT4G5mi9hOGVl', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/44562710', // B站主页
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=22677570.mp3',
      cover:
            'https://pic.yz001.online/images/2024/05/01/7DIO6.jpg'
    },
  ],
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '608315400', // 对应歌单的 id
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://waline.391314520.xyz/', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
  ...
  IMG_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMG_COMPRESS_WIDTH || 2400, // Notion图片压缩宽度
